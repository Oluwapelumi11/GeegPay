...
@Component({
    ...
    <div class="dark:bg-gray-800 w-full h-[488px] flex flex-col gap-[10px] justify-between bg-[#FAFAFA] ">
        <div class="flex sm:justify-center justify-between pr-2 pl-3 py-3 items-center sm:px-0 sm:py-0">
            <div [routerLink]="['']" [routerLinkActiveOptions]="{exact:true}" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 flex items-center">
                ...
                <p class= "text-[#26282C] dark:text-gray-100 sm:hidden flex px-3  text-2xl font-semibold font-jakarta first-letter :text-[#34CAA5] first-letter:text-3xl">GeegPay</p>
            </div>
        ...
        <div [routerLink]="['']" [routerLinkActiveOptions]="{exact:true}" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 flex group relative font-bold sm:justify-center  text-right  bg-opacity-0 transition-all ease-in-out duration-700 px-3 sm:px-0 bg-gray-300 py-2" data-tooltip-placement="right" data-tooltip-target="dashboard">
  ...
  <path [attr.fill]="isDarkMode ? '#34CAA5' : '#0D062D'" opacity="0.4" d="M7.24 13.4301H5.34C3.15 13.4301 2 14.5801 2 16.7601V18.6601C2 20.8501 3.15 22.0001 5.33 22.0001H7.23C9.41 22.0001 10.56 20.8501 10.56 18.6701V16.7701C10.57 14.5801 9.42 13.4301 7.24 13.4301Z"/>
            ...
            <a routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200">Dashboard</a>
        ...
        <div id="dashboard" role="tooltip" class="absolute z-10 hidden invisible sm:inline-block px-3 py-2  text-sm font-medium dark:text-gray-200  text-white transition-opacity duration-500 whitespace-nowrap bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
            ...
            <div class="tooltip-arrow" data-popper-arrow></div>
                ...
                <div [routerLink]="'/metrics'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 flex  group relative font-bold sm:justify-center  text-right hover: bg-opacity-0 transition-all ease-in-out duration-700 px-3 sm:px-0 bg-gray-100 py-2"  data-tooltip-placement="right" data-tooltip-target="sales">

            <a [routerLink]="'/metrics'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100"><img src="../assets/svgs/trend-up.svg" alt=""></a>
            <a routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200">Sales Metrics</a>
        ...
        <div id="sales" role="tooltip" class="absolute z-10 hidden invisible sm:inline-block px-3 py-2  text-sm font-medium dark:text-gray-200  text-white transition-opacity duration-500 whitespace-nowrap bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
            ...
            <div class="tooltip-arrow" data-popper-arrow></div>
                ...
                <div [routerLink]="'profile'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 flex group relative font-bold sm:justify-center  text-right hover: bg-opacity-0 transition-all ease-in-out duration-700 px-3 sm:px-0 bg-gray-100 py-2"  data-tooltip-placement="right" data-tooltip-target="profile">

            <a [routerLink]="'profile'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100"><img src="../assets/svgs/profile-2user.svg" alt=""></a>
            <a routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200">Profile</a>
        ...
        <div id="profile" role="tooltip" class="absolute z-10 hidden invisible sm:inline-block px-3 py-2  text-sm font-medium dark:text-gray-200  text-white transition-opacity duration-500 whitespace-nowrap bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
            ...
            <div class="tooltip-arrow" data-popper-arrow></div>
                ...
                <div [routerLink]="'clients'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 flex group relative font-bold sm:justify-center  text-right hover: bg-opacity-0 transition-all ease-in-out duration-700 px-3 sm:px-0 bg-gray-100 py-2"  data-tooltip-placement="right" data-tooltip-target="clients">

            <a [routerLink]="'clients'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100"><img src="../assets/svgs/box.svg" alt=""></a>
            <a [routerLink]="'clients'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200 ">Clients</a>
        ...
        <div [routerLink]="['/promotions']" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="flex group rela4ive font-bold sm:justify-center  text-right hover: bg-opacity-0 transition-all ease-in-out duration-700 px-3 sm:px-0 bg-gray-100 py-2"  data-tooltip-placement="right" data-tooltip-target="proms">

            <a [routerLink]="'promotions'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100"><img src="../assets/svgs/discount-shape.svg" alt=""></a>
            <a  routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200 ">Promotions</a>
        ...
        <div [routerLink]="'informations'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 flex group relative font-bold sm:justify-center  text-right hover: bg-opacity-0 transition-all ease-in-out duration-700 px-3 sm:px-0 bg-gray-100 py-2"  data-tooltip-placement="right" data-tooltip-target="info">

                    <a [routerLink]="'informations'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100"><img src="../assets/svgs/info-circle.svg" alt=""></a>
                    <a routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200">Informations</a>
    ...
    <div class=" w-full h-[152px]  flex flex-col gap-[16px] bg-[#FAFAFA] dark:bg-gray-800 items-center justify-end  sm:justify-evenly">
        <div [routerLink]="'geegpay'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 hidden sm:flex"  data-tooltip-placement="right" data-tooltip-target="go">
        ...
        <div  [routerLink]="" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 hidden sm:flex"  data-tooltip-placement="right" data-tooltip-target="settings">
         ...
         <div  [routerLink]="'logout'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 hidden sm:flex"  data-tooltip-placement="right" data-tooltip-target="logout">
        ...
        <a routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200">Settings</a>
    ...
    <div  [routerLink]="'logout'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class="dark:text-gray-400 flex group relative w-full sm:hidden font-bold sm:justify-center  text-right hover: bg-opacity-0 transition-all ease-in-out duration-700 px-3 sm:px-0 bg-gray-300 py-2"  >
        
        <a [routerLink]="'logout'" routerLinkActive="bg-opacity-70 dark:bg-opacity-100"><img src="../assets/svgs/logout.svg" alt=""></a>
        <a routerLinkActive="bg-opacity-70 dark:bg-opacity-100 dark:text-gray-800" class= " text-[#26282C4] px-3 flex sm:hidden dark:text-gray-200">Logout</a>
